...
public class Clubgoer extends Thread {
	...
	private void checkPause() {
		//Make the clubgoer stop moving when the pause flag is thrown
		synchronized(ClubGrid.pushPause)
		{
			//Only pauses the threads which are in the club or about to enter the club.
	...
	private void startSim() {
		//Wait until the gates are opened for threads to enter the club
		try {
